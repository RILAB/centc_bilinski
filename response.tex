...
Nonetheless, most of our clusters contain many unique CentC, suggesting either that gene conversion is infreqeunt or point mutations are common. We have added text to the discussion mentioning gene conversion} 
...
\res{Per generation, assuming one generation.  Clarified in text. **PAPER**}

\item page 6, line 6 from bottom, a typo for kinetochore.

\res{Spelling corrected. **paper**}
