...
\author{Paul Bilinski \and Kevin Distor \and Jose Gutierrez-Lopez \and Gabriela Mendoza Mendoza \and Jinghua Shi \and Kelly Dawe \and Jeffrey Ross-Ibarra}
...
Centromere repeats are found in most eukaryotes and play a critical role in kinetochore formation.  Though CentC repeats exhibit considerable diversity both within and among species, little is understood about the mechanisms that drive centromere repeat evolution.  Here, we use maize as a model to investigate how a complex history involving polyploidy, fractionation, and recent domestication has impacted the diversity of the maize CentC repeat.  We first validate the existence of long tandem arrays of repeats in maize and other taxa in the genus \emph{Zea}.  We find that genetic similarity among CentC copies is highest within these arrays, suggesting that tandem duplications are the primary mechanism for the generation of new copies.  However, we do not observe distinct genetic groups within tandem arrays, but instead find that homoplasious mutations may have homogenized CentC diversity.  Although the two ancestral subgenomes of maize have contributed nearly equal numbers of centromeres, our analysis shows that a vast majority of all CentC repeats derive from  one of the parental genomes.  Finally, by comparing maize with its wild progenitor teosinte, we find that the abundance of CentC has decreased through domestication while the pericentromeric repeat Cent4 has drastically increased. 
...
However, little is known about the genetic mechanisms that produce centromere repeat diversity, though we can begin investigating potential mechanisms with improved assemblies of centromeric regions.
...
Maize centromeres are comprised primarily of the 156bp satellite repeat CentC and the CRM family of retrotransposons.
...
But while we can cluster the repeats into groups of related sequences, these groups seem to have little relation to current or ancient maize chromosomes (Figure \ref{pcoa}).  
We see no evidence of chromosome specific repeats such as that seen in \emph{Arabidopsis} species \citep{Kawabe2005, Pontes2004}, suggesting the presence of a mechanisms that homogenizes repeats across centromeres on different chromosomes. 
...
Instead of chromosome-specific groups, we find that virtually all the large arrays of CentC in the maize  genome derive from one of the two ancestral genomes present in modern day \emph{Zea} (Figure \ref{circos}).  
...
Large CentC clusters are clearly biased in favor of subgenome 1, which is known to have lower gene loss and higher average expression than maize subgenome 2 \citep{Schnable2011}. 
Consistent with a correlation between expression and CentC loss in subgenome 2, \citet{ReinhartBartel2002} find evidence of regulatory microRNA’s corresponding to centromeric repeats.   
An alternative explanation is simply that the subgenome 1 parent had more or larger CentC arrays, leading to an initial unequal representation in the ancient polyploid ancestor of maize.
