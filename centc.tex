...
We see no evidence of chromosome specific repeats such as that seen in X and Y \citep{Kawabe2005, Pontes2004}, with the currently available evidence suggesting that the chromosome 4 repeats previously called Cent4 is in fact a poorly characterized retrotransposon.  
...
One possible explanation for this clear bias is that differential expression between subgenomes affects centromere function.  Regulatory microRNA’s corresponding to centromeric repeats have been observed\citep{ReinhartBartel2002}, and perhaps the silenced centromere became more susceptible to deletion just like other parts of subgenome2.  We see no evidence of a more rapid decay of CentC sequences in subgenome2, but we likely have poor ability to detect deletion of entire tandem arrays.  An alternative explanation is simply that the subgenome1 parent had more or larger CentC arrays, leading to an unequal representation in the ancient polyploid ancestor of maize.
